...
title: 'CLI'
sidebarTitle: 'CLI'
description: 'The ligate command-line tool. Generate keys, claim from the faucet, transfer AVOW, register schemas and submit attestations against ligate-devnet-1. Written in Rust, no JS runtime required.'
---
