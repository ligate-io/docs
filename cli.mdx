...
title: 'CLI'
sidebarTitle: 'CLI'
description: 'The ligate command-line tool. Generate keys, claim from the faucet, transfer AVOW, register schemas and submit attestations against ligate-devnet-3. Written in Rust, no JS runtime required.'
---
...
<Tip>
  Wires up against `ligate-devnet-3` out of the box. Default RPC:
  `https://rpc.ligate.io`. Latest release:
  [`v0.2.2`](https://github.com/ligate-io/ligate-cli/releases/latest).
  Source:
